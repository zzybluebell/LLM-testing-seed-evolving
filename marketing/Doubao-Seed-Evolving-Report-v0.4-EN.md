...
Charts ([`scripts/report.py`](https://github.com/zzybluebell/LLM-testing-seed-evolving/blob/main/scripts/report.py)): [`results/charts/lift.png`](https://github.com/zzybluebell/LLM-testing-seed-evolving/blob/main/results/charts/lift.png) (vague vs detailed), [`results/charts/context_growth.png`](https://github.com/zzybluebell/LLM-testing-seed-evolving/blob/main/results/charts/context_growth.png) (request tokens per turn, cache-read share in a lighter shade), [`results/charts/time_split.png`](https://github.com/zzybluebell/LLM-testing-seed-evolving/blob/main/results/charts/time_split.png) (first token / model / tool time).
